...
solution file add "$PROJECT_BASE_DIR/src/EdgeDetect_SinglePort.h" -type C++
solution file add "$PROJECT_BASE_DIR/../01_EdgeDetect_Algorithm/src/EdgeDetect_Algorithm.h" -type C++ -exclude true
solution file add "$PROJECT_BASE_DIR/tb/EdgeDetect_SinglePort_tb.cpp" -type C++ -exclude true
